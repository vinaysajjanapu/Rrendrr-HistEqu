package com.vinay.rrendrr_histequ;
...
import com.vinay.rrendrr_histequ.RSEditUtils;
...
public class Edit extends AppCompatActivity {
    ...
    private class HistogramEqualizationTask extends AsyncTask<Void, Void, Long> {
        ...
        protected Long doInBackground(Void... params) {
            ...
            editedImage = RSEditUtils.histogramEqualization(image, Edit.this);
    ...
    private class BlurTask extends AsyncTask<Void, Void, Long> {
        ...
        protected Long doInBackground(Void... params) {
            long begin = System.currentTimeMillis();
            editedImage = RSEditUtils.blurBitmap(editedImage, 25.0f, Edit.this);
            long end = System.currentTimeMillis();
            long time = end-begin;
            return time;
        }
